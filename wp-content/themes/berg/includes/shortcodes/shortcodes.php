...
function umbrella_accordiongroup_shortcode($atts,$content){
    ...
    <script>jQuery(document).ready(function(){loadAccordionsShortcode();});</script>
";
    return $return_statement;
}
...
function umbrella_tabgroup_shortcode($atts, $content){
    ...
    $return_statemenet .= '</ul>
     </div> <script> jQuery(document).ready(function(){loadTabsShortcode();}); </script>';
...
function umbrella_button_shortcode($atts,$content){
    ...
    return "<a href='{$url}' class='btn {$color} {$type}'>{$content}</a>";
}
...
add_shortcode("layout_btn","umbrella_layout_shortcode");
/*Layout*/
...
function add_plugin( $plugin_array ) {
    $plugin_array['accordion_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
    $plugin_array['toggle_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
    $plugin_array['tab_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
    $plugin_array['alert_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
    $plugin_array['highlight_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
    $plugin_array['button_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
    //$plugin_array['video_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
    $plugin_array['layout_btn'] = get_template_directory_uri() . '/includes/shortcodes/tiny_mce_buttons.js';
