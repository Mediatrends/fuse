...
function umb_notification_wizard(){
    ...
    <select id="um_notification">
        <option value="alert-info"><?php _e("Info","um_lang"); ?></option>
        <option value="alert-success"><?php _e("Success","um_lang"); ?></option>
        <option value="alert-warning"><?php _e("Warning","um_lang"); ?></option>
        <option value="alert-danger"><?php _e("Error","um_lang"); ?></option>
    </select><br><br>
