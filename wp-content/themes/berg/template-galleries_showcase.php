<?php
/*
Template Name:Galleries Showcase
*/
?>
...
<section class="content galleryShowcase">
	<div class="container">
		...
		<ul id="da-thumbs" class="da-thumbs">
			...
			<?php if($the_Query->max_num_pages != 1):?>	
				<li class="col-md-2 col-sm-4 col-xs-12">
					<article class="loadMore bounceIn animated ">
						<a href="#">
							<img src="<?php echo get_template_directory_uri().'/assets/css/transparentLoadMore.png'; ?>" >
							<article class="loadText">
								<p class="loadMoreText"><?php _e('Load More ...','um_lang'); ?></p>
									<article class="um_spinner">
